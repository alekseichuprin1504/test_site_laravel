...
Route::group([
	...
	Route::post('/store_edit_advantage/{id}', 'AdvantageController@storeEdit')->name('admin_store_edit_advantages');
	Route::delete('/delete/{id}', 'AdvantageController@deleteAdvantages')->name('admin_delete_advantages');
	...
	Route::post('/store_edit_contact/{id}', 'ContactController@storeEditContact')->name('admin_store_edit_contact');
	Route::delete('/delete_contact/{id}', 'ContactController@deleteContact')->name('admin_delete_contact');
	...
	Route::post('/store_edit_tour/{id}', 'TourController@storeEditTour')->name('admin_store_edit_tour');
	Route::delete('/delete_tour/{id}', 'TourController@deleteTour')->name('admin_delete_tour');
	...
	Route::post('/store_edit_condition/{id}', 'ConditionController@storeEditCondition')->name('admin_store_edit_condition');
	Route::delete('/delete_condition/{id}', 'ConditionController@deleteCondition')->name('admin_delete_condition');
